...
-- notify_purchase_status_change 함수에 반려 케이스 추가
...
-- 설명 업데이트
COMMENT ON FUNCTION notify_purchase_status_change() IS '발주/구매 요청의 모든 상태 변경 알림을 처리하는 통합 함수 (반려 알림 포함)';

-- 반려 사유 컬럼이 없는 경우 추가
ALTER TABLE purchase_requests 
ADD COLUMN IF NOT EXISTS middle_manager_comment TEXT;
